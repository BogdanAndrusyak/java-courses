...
import ru.parsentev.modelsPets.Animal;
import ru.parsentev.modelsPets.Dog;
import ru.parsentev.modelsPets.Pet;
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        writer.append(
                "<!DOCTYPE html>" +
                        ...
                        "</head>" +
                        "<body>" +
                        "     <ru.parsentev.form action='"+req.getContextPath()+"/' method='post'>" +
